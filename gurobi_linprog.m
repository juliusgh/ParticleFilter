function [x,fval,exitflag,output,lambda] = gurobi_linprog(f,A,b,Aeq,beq,lb,ub,x0,options)
%Copyright 2020, Gurobi Optimization, LLC
%
%GUROBI_LINPROG A linear programming example using the Gurobi MATLAB interface
%
